...
% taking into account hystersis, eddy-current and excess losses in the
% laminated core.
% 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%5
  ...
  % Finished correctly
    ...
    % U and I have different sampling thatn B and H since they are
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%5
  ...
  figure;
  plot(H, B);
  title(sprintf('{\\itf}_{s} = %g kHz', fs/1e3));
  xlabel('Surface field strength {\ith}_s (A/m)', 'FontSize', 14);
  ylabel('Average flux density {\itb}_0 (T)', 'FontSize', 14);  
